    ...
    <div className="Leftbar">
      <div className="NotificationsContainer">
        <div style={{ display: "flex", justifyContent: "space-around" }}>
          <p style={{ marginLeft: "-14px" }}>Notificaciones</p>
          <p style={{ color: "#aaa", marginLeft: "40px" }}>Ver todo</p>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", marginTop: -10 }}>
          ...
          >
            Esneider ha empezado a seguirte
          </p>
      ...
      <div className="NotificationsContainer">
        <div style={{ display: "flex", justifyContent: "space-around" }}>
          <p style={{ marginLeft: "-20px" }}>Para explorar</p>
          <p style={{ color: "#aaa", marginLeft: "40px" }}>Ver todo</p>
        </div>
        <div>
          {post.map((item) => [
